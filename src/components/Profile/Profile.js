                ...
                <article className="profile-article-html">
                    <main className="profile-main-html">
                        <form className="profile-form-contents">
                            ...
                            <hr />
                            <p >{this.state.name}</p>
                            <p >Images submitted: {this.props.user.entries}</p>
                            <hr id="second-hr" />
                            <section className="profile-input-updates-section">
                                ...
                                <div className="profile-input-update-container image">
                                    ...
                                    <label for="file" className="profile-file-upload">
                                        ...
                                        <div className="text">
                                            <span id="displayed-text">Click to upload image</span>
                                        </div>
                                        <input id="file" type="file" name="profile-img" onChange={this.onFormChange}></input>
                                    </label>
                                </div>
                            </section>
                        </form>
                    ...
                    <div className="modify-options-container">
                            <button className="profile-update-button" onClick={() => this.onProfileUpdate({ name, profileImg })}>Save Changes</button>
                            <button className="profile-update-button" onClick={this.props.toggleModal}>Cancel</button>
                    </div>
                </article>
            </div>
        )
